...
# Function to compute heading from magnetometer readings
def calculate_heading(mx, my):
    heading_rad = math.atan2(mx, my)  # Compute heading in radians
    heading_deg = math.degrees(heading_rad)  # Convert to degrees
    if heading_deg < 0:
        heading_deg += 360  # Ensure the heading is in the range 0-360°
    return heading_deg
