...
RudderControlHelper& RudderControlHelper::getInstance() 
{
    // Create a static instance of the class
    static RudderControlHelper instance;
    return instance;
}


// Calculating distance between two coordinate points using the Haversine Formula
float RudderControlHelper::calculate_distance(sensor_msgs::msg::NavSatFix coord1, sensor_msgs::msg::NavSatFix coord2)
{
...
float RudderControlHelper::calculate_bearing(sensor_msgs::msg::NavSatFix curr_coord, sensor_msgs::msg::NavSatFix tar_coord)
{
...
sensor_msgs::msg::NavSatFix RudderControlHelper::convert_to_position(sensor_msgs::msg::NavSatFix position, float angle, float distance)
{
...
RudderControlHelper::RudderControlHelper() {
