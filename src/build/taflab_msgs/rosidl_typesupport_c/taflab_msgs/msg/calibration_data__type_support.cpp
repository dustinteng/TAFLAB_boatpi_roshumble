...
static const _CalibrationData_type_support_symbol_names_t _CalibrationData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, taflab_msgs, msg, CalibrationData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, taflab_msgs, msg, CalibrationData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, taflab_msgs, msg, CalibrationData)() {
  return &::taflab_msgs::msg::rosidl_typesupport_c::CalibrationData_message_type_support_handle;
}
