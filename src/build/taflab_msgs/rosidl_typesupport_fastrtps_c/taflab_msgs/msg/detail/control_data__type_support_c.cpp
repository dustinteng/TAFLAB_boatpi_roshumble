...
#include "taflab_msgs/msg/detail/control_data__rosidl_typesupport_fastrtps_c.h"
...
using _ControlData__ros_msg_type = taflab_msgs__msg__ControlData;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: servo_rudder
  {
    cdr << ros_message->servo_rudder;
  }

  // Field name: servo_sail
  {
...
size_t get_serialized_size_taflab_msgs__msg__ControlData(
  const void * untyped_ros_message,
...
static uint32_t _ControlData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_taflab_msgs__msg__ControlData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_taflab_msgs
size_t max_serialized_size_taflab_msgs__msg__ControlData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = taflab_msgs__msg__ControlData;
    is_plain =
      (
...
static size_t _ControlData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_taflab_msgs__msg__ControlData(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, taflab_msgs, msg, ControlData)() {
