// Filename: RudderControlHelper.hpp
// Author: Kieran Pereira
// Last Modified: 11/11/2024
// Description: A script containing all relevant functions to do coordinate calculations
